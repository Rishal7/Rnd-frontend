  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-24 pt-20 md:pt-28">
        ...
        {/* Updated to the correct heading level: h2 */}
        <h2 className="animate-fade-rise animate-delay-2 mb-12 max-w-xl text-lg font-light text-gray-700">
        ...
        <div className="animate-fade-rise animate-delay-3 mb-16 grid gap-8 md:grid-cols-2 md:gap-12">
          ...
          <div className="flex flex-col justify-center gap-6">
            <div className="float-orb rounded-sm border border-[(--border-subtle)] bg-[(--bg-elevated)] p-10 card-hover">
              ...
              <p className="text-2xl font-extralight text-gray-800">Lumen sideboard</p>
              <p className="mt-3 text-sm text-gray-700">Oak, brass, silence.</p>
            </div>
            {/* Div pretending to be a button: not focusable, no role/name */}
            <div
              className="cta-pulse cursor-pointer rounded-sm border border-(--gold) bg-(--gold)/10 px-8 py-4 text-center text-sm tracking-widest text-[#DAA520]"
            ...
            <Link
              to="/reach"
              className="text-center text-sm text-gray-800 underline-offset-4 hover:underline"
            >
