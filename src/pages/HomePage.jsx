  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-24 pt-20 md:pt-28">
        <p className="animate-fade-rise mb-6 text-xs tracking-[0.35em]" style={{ color: '#B8860B' }}>EST. MMXXIV</p>
        ...
        {/* Adjusted heading level to maintain logical order: h1 → h2 */}
        <h2 className="animate-fade-rise animate-delay-2 mb-12 max-w-xl text-lg font-light text-gray-800">
        ...
        <div className="animate-fade-rise animate-delay-3 mb-16 grid gap-8 md:grid-cols-2 md:gap-12">
          ...
          <div className="flex flex-col justify-center gap-6">
            <div className="float-orb rounded-sm border border-(--border-subtle) bg-(--bg-elevated) p-10 card-hover">
              <p className="mb-4 text-xs tracking-[0.25em]" style={{ color: '#FFD700' }}>SIGNATURE</p>
              <p className="text-2xl font-extralight text-gray-900">Lumen sideboard</p>
              <p className="mt-3 text-sm" style={{ color: '#444444' }}>Oak, brass, silence.</p>
            </div>
            ...
            <Link
              to="/reach"
              className="text-center text-sm text-gray-900 underline-offset-4 hover:underline"
            >
        ...
        <div id="featured" className="mb-4 text-xs tracking-[0.3em]" style={{ color: '#B8860B' }}>
          FEATURED
        </div>
        <p className="max-w-2xl text-sm text-gray-900/90">
