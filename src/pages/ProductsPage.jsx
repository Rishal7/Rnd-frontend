...
export function ProductsPage() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      ...
      <p className="mb-3 max-w-lg text-sm text-[#333333]">
        Reserve objects from the current rotation.
      </p>
      <p className="mb-16 max-w-lg text-xs leading-relaxed text-[#555555]">
          ...
          {pieces.map((item) => (
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-[#555555]">{item.note}</p>
        ...
        <div className="rounded-sm border border-(--border-subtle) bg-(--bg-card) p-8">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <input
              ...
              className="w-full border-0 border-b border-(--border-subtle) bg-transparent py-2 text-sm text-[--mist] placeholder:text-[#555555] outline-none"
            />
            <input
              type="email"
              name="email"
            ...
            <textarea
              ...
              placeholder="Notes"
              rows={3}
              className="w-full resize-none border-0 border-b border-(--border-subtle) bg-transparent py-2 text-sm text-[--mist] placeholder:text-[#555555] outline-none"
            />
            ...
            <button
              type="button"
              className="mt-2 h-5 px-1 text-[10px] text-[#555555]"
            >
              Clear
            </button>
          </form>
